...
public class CustomFileUtils {
    ...
    public final static String FILE_PATH_DOWNLOAD = "E:" + File.separator + "MyServerFile" + File.separator;

    public final static String FILE_PATH_UPLOAD = "E:" + File.separator + "MyServerFile" + File.separator + "file" + File.separator;
