...
public class DESUtil {
    ...
    public String encrypt(String source, String charSet)
            throws UnsupportedEncodingException {
        String encrypt = null;
        byte[] ret = encrypt(Base64.encode(source).getBytes(charSet));
        encrypt = Base64.encode(new String(ret));
        return encrypt;
    }
    ...
    public String decrypt(String encryptedData, String charSet)
        ...
        byte[] ret = descrypt(Base64.decode(encryptedData).getBytes());
        descryptedData = Base64.decode(new String(ret, charSet));
